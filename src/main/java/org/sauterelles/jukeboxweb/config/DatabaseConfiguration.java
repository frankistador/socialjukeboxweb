...
@Configuration
@EnableJpaRepositories("org.sauterelles.jukeboxweb.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "org.sauterelles.jukeboxweb.config.HerokuDatabaseConfiguration")
